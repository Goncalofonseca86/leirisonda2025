...
export class ErrorBoundary extends Component<Props, State> {
  ...
  public static getDerivedStateFromError(error: Error): State {
    ...
    const recoversableErrors = [
      ...
      "sync após",
      "after_delete",
      "Timeout na eliminação",
      "ELIMINAÇÃO ULTRA ROBUSTA",
      "eliminação de emergência",
      "deleteWork falhou",
      "Obra foi eliminada localmente",
      "Eliminação de emergência",
      "obra ainda existe localmente",
      "verificando eliminação local",
      "forçando eliminação local",
      "Promise.race",
      "timeout agressivo",
      "deleteWork retornou",
      "obra pode ter sido eliminada",
      "eliminação não conseguiu ser confirmada",
      "eliminação local funcionou",
      "Falha na eliminação local",
      "Falha crítica na eliminação",
      "ELIMINAÇÃO LOCAL GARANTIDA",
      "background",
